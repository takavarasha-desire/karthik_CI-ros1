pipeline {
  ...
  stages {
    ...
    stage('Run Tests') {
      steps {
        echo "Running waypoints test in ${DOCKER_IMAGE}:${DOCKER_TAG}"
        sh '''
          ...
          docker run --rm \
            ...
            ${DOCKER_IMAGE}:${DOCKER_TAG} bash -lc '
              ...
              echo "Simulation ready. Running waypoints test..."
